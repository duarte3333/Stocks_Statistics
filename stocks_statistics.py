...
def main():
    ...
    criar_grafico(datas, inv_acumuladoF,"Graph: Total money invested - Time","Time", "Total invested money")
    criar_grafico(datas, lista_profits_acumulados,"Graph: Total Profit - Time","Time", "Total profit")
